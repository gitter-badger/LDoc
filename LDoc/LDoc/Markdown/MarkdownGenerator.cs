    ...
    public abstract class MarkdownGenerator
        ...
        private void WriteFooter(GitHubMarkdown MD)
            ...
            MD.Table(new[]
                ...
                new[]
                    {
                    $"This markdown was generated by {MD.Link(LUnit.LUnit.Urls.GitHubRepository_LUnit, nameof(LUnit))}, " +
                    $"powered by {MD.Link(LUnit.LUnit.Urls.GitHubRepository_LCore, nameof(LCore))}",
                    ""
                    }
                }, IncludeHeader: false);
            }
