...
namespace LDoc_Tests.LCore.LDoc.Markdown
{
    ...
    public partial class MarkdownTester : XUnitOutputTester, IDisposable
    {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.BlankLine) + "(Boolean)")]
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.HeaderAnchor) + "(String, String&, Int32, Boolean) => String")]
        public void HeaderAnchor()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.Markdown.HeaderAnchor
        }

        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.HeaderUnderline) + "(String, Int32, Boolean)")]
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.HorizontalRule) + "(Boolean)")]
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.BlockQuote) + "(String[], Boolean)")]
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.Strikethrough) + "(String, Boolean) => String")]
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.Code) + "(String[], String, Boolean)")]
        public void Code()
        {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown)+ "." + nameof(global::LCore.LDoc.Markdown.Markdown.InlineCode) + "(String, Boolean) => String")]
