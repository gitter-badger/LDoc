...
namespace LDoc_Tests.LCore.LDoc.Markdown
{
    ...
    {
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.MicrosoftSystemReferencePath) + "(Type) => String")]
        public void MicrosoftSystemReferencePath()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.MicrosoftSystemReferencePath
        }

        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.FindMarkdown) + "(MemberInfo) => GitHubMarkdown_MemberGroup")]
        public void FindMarkdown()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.FindMarkdown
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.FormatComment) + "(String) => String")]
        public void FormatComment()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.FormatComment
        }

        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.LinkToType) + "(GitHubMarkdown, Type) => String")]
        public void LinkToType()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.LinkToType
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.GetBadges_Info) + "(GitHubMarkdown_Type, TypeCoverage, ICodeComment) => List<String>")]
        public void GetBadges_Info()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.GetBadges_Info
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.GetBadges_Coverage) + "(GitHubMarkdown_Type, TypeCoverage, ICodeComment) => List<String>")]
        public void GetBadges_Coverage()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.GetBadges_Coverage
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.GetBadges_Info) + "(GitHubMarkdown_MemberGroup, MethodCoverage, ICodeComment) => List<String>")]
        public void GetBadges_Info()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.GetBadges_Info
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(MarkdownGenerator)+ "." + nameof(MarkdownGenerator.GetBadges_Coverage) + "(GitHubMarkdown_MemberGroup, MethodCoverage, ICodeComment) => List<String>")]
        public void GetBadges_Coverage()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.MarkdownGenerator.GetBadges_Coverage
        }
