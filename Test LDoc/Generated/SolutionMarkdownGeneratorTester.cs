...
namespace LDoc_Tests.LCore.LDoc.Markdown
{
    ...
    public partial class SolutionMarkdownGeneratorTester : XUnitOutputTester, IDisposable
    {
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(SolutionMarkdownGenerator)+ "." + nameof(SolutionMarkdownGenerator.GenerateTagSummaryMarkdown) + "(String) => MarkdownDocument_TagSummary")]
        public void GenerateTagSummaryMarkdown()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.SolutionMarkdownGenerator.GenerateTagSummaryMarkdown
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(SolutionMarkdownGenerator)+ "." + nameof(SolutionMarkdownGenerator.LinkToString) + "(GeneratedDocument, String) => String")]
        public void LinkToString()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.SolutionMarkdownGenerator.LinkToString
        }
        ...
        [Fact]
        [Trait(Traits.TargetMember,nameof(LCore)+ "." + nameof(global::LCore.LDoc)+ "." + nameof(global::LCore.LDoc.Markdown)+ "." + nameof(SolutionMarkdownGenerator)+ "." + nameof(SolutionMarkdownGenerator.SaveCategoryPieChart) + "(IEnumerable<T>, Func<T, String>, String, Nullable<Size>)")]
        public void SaveCategoryPieChart()
        {
            // TODO: Implement method test LCore.LDoc.Markdown.SolutionMarkdownGenerator.SaveCategoryPieChart
        }
